...
- 임시 DSDS 포탈 : https://dsds.mwebdev.samsungds.net
- 임시 사내 npm 레포 : https://npm.mwebdev.samsungds.net

## 사전 준비

- Node.js v20 이상 LTS버전 (v22 LTS 추천).
- `pnpm` 설치
    ```
    npm install -g pnpm@latest-10
    ```
- `$HOME/.npmrc` (Windows 라면 `%APPDATA%\.npmrc`) 파일에 아래 내용을 **꼭** 추가해주세요. (pnpm 사용시 문제 해결)
    ```
