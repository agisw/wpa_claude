...
import { LNBUnionIcon } from "@/components/ui"
 ...
 */
export const newTreeOnlySample: LNBInputItem = {
  icon: LNBUnionIcon,
  ...
  items: [
    {
      ...
      items: [
        {
          id: "1-1",
          content: "중그룹 트리(Tree) 2depth11111111111",
          items: [
            {
              type: "item",
              id: "1-1-1",
              content: "항목(Item)1111111111111111",
            },
            {
              type: "item",
              id: "1-1-2",
...
export const newTreeOnlyDescription = {
