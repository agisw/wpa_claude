...
const iconClassNames = {
  medium: {
    before: "pl-button-px-medium-icon-text!",
    after: "pr-button-px-medium-icon-text!",
  },
  small: {
    after: "pr-button-pr-small-icon-after-text",
  },
}
...
/** Button 컴포넌트의 variant 및 size 속성을 정의하는 타입 */
 ...
 * - `iconOption` 을 통해 위치(`before`/`after`) 지정이 가능합니다.
 * - `active`, `selected`, `disabled` 등 상태에 따라 시각적 스타일이 자동 적용됩니다.
 * - `children`: 버튼의 텍스트 또는 `ReactNode`를 지정합니다.
