...
export const LoremIpsumContent = ({ className }: Props) => {
  return (
    <div
      className={cn(
        "typo-sok-body-14-400 scrollbar-thin overflow-auto border border-[var(--color-border-btn-2ndary-border-default)] px-[8px] py-[6px] whitespace-pre-wrap",
        className
      )}
    >
      <p>
      ...
      <p>
        ...
        standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32
        and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form,
        accompanied by English versions from the 1914 translation by H. Rackham. Contrary to popular belief, Lorem Ipsum
