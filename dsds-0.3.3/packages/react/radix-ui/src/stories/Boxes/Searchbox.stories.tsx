...
import { Searchbox } from "@/components/ui/boxes/Searchbox"
...
const meta = {
  title: "Components/Textbox/Searchbox",
  tags: ["autodocs"],
  component: Searchbox,
  parameters: {
    layout: "centered",
    ...
    (Story: React.ComponentType<Story>, context) => {
      return (
        <div className="grid gap-4" style={{ gridTemplateColumns: "120px 120px 120px 120px" }}>
          ...
          {/* Main row */}
          <Story args={{ ...context.args, value: undefined, disabled: false }} />
          <Story
            args={{
              ...context.args,
              value: "Text",
