...
export function ToggletipDemo() {
  ...
  return (
    <div className="flex flex-col">
      <DemoRowTitle title="Pagination" />
      <div className="flex h-[200px] flex-col pt-[100px]">
        <div className="flex flex-1 items-center justify-center">
          <Toggletip open>
            <ToggletipTrigger>
              <Button children="Press Button to Turn the Page" size="large" variant="secondary" />
            </ToggletipTrigger>
            <ToggletipFrame avoidCollisions={false} side={"top"} size={"small"} align={"center"}>
      ...
      <DemoRowTitle title="Page Content Form" />
      <div className="flex h-[320px] flex-col pt-[200px]">
        <div className="flex flex-1 items-center justify-center gap-[70px]">
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"top"} size={"small"} align={"center"}>
              ...
              <ToggletipFooter page={pages.length} currentPage={1}></ToggletipFooter>
            </ToggletipFrame>
          </Toggletip>
          <Toggletip open>
            <ToggletipTrigger>
            ...
            <ToggletipFrame avoidCollisions={false} side={"top"} size={"small"} align={"center"}>
              <ToggletipPages pages={pages} currentPage={2} />
              <ToggletipFooter page={pages.length} currentPage={2}></ToggletipFooter>
            </ToggletipFrame>
          </Toggletip>
          <Toggletip open>
            <ToggletipTrigger>
            ...
            <ToggletipFrame avoidCollisions={false} side={"top"} size={"small"} align={"center"}>
              <ToggletipPages pages={pages} currentPage={3} />
              <ToggletipFooter page={pages.length} currentPage={3}></ToggletipFooter>
            </ToggletipFrame>
          </Toggletip>
        </div>
      </div>
      <div className="flex h-[250px] flex-col pt-[150px]">
        <div className="flex flex-1 items-center justify-center gap-[70px]">
          <Toggletip open>
            <ToggletipTrigger>
              <Button children="Press Button to Turn the Page" size="large" variant="secondary" />
            ...
            <ToggletipFrame avoidCollisions={false} side={"top"} size={"small"} align={"center"}>
              <ToggletipPages pages={pages} currentPage={4} />
              <ToggletipFooter page={pages.length} currentPage={4}></ToggletipFooter>
            </ToggletipFrame>
          </Toggletip>
          <Toggletip open>
            <ToggletipTrigger>
            ...
            <ToggletipFrame avoidCollisions={false} side={"top"} size={"small"} align={"center"}>
              <ToggletipPages pages={pages} currentPage={5} />
              <ToggletipFooter page={pages.length} currentPage={5}></ToggletipFooter>
            </ToggletipFrame>
          </Toggletip>
        </div>
      </div>
      ...
      <div className="flex flex-col pt-[100px]">
        <div className="flex flex-1 items-center justify-between">
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"top"} size={"small"} align={"start"}>
          ...
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"top"} size={"small"} align={"end"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
        </div>
      ...
      <div className="flex flex-col pt-[20px]">
        <div className="flex flex-1 items-center justify-evenly">
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"left"} size={"small"} align={"start"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"right"} size={"small"} align={"start"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
        </div>
        <div className="flex flex-1 items-center justify-evenly pt-[100px]">
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"left"} size={"small"} align={"center"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"right"} size={"small"} align={"center"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
        </div>
        <div className="flex flex-1 items-center justify-evenly pt-[100px]">
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"left"} size={"small"} align={"end"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"right"} size={"small"} align={"end"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
        </div>
        <div className="flex flex-1 items-center justify-between pb-[200px]">
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"bottom"} size={"small"} align={"start"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"bottom"} size={"small"} align={"center"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
          <Toggletip open>
            ...
            <ToggletipFrame avoidCollisions={false} side={"bottom"} size={"small"} align={"end"}>
              <ToggletipPages pages={pagesAlign} currentPage={1} />
            </ToggletipFrame>
          </Toggletip>
        </div>
