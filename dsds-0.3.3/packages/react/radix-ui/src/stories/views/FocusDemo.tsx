...
import { Checkbox, Label, Radio, RadioItem, Searchbox, Textbox, Toggle, type ButtonVariantProps } from "@/components/ui"
  ...
  return (
    ...
    >
      ...
      <div className={cn("mb-2 flex items-center gap-3 p-1", className)}>
        <Checkbox />
        <Radio orientation="horizontal" defaultValue="on" className="border-1 border-gray-100 p-1">
          <Label htmlFor="radiobox1">on</Label>
          <RadioItem value="on" id="radiobox1" />
          <Label htmlFor="radiobox2">off</Label>
          <RadioItem value="off" id="radiobox2" />
        </Radio>
        <Toggle size="small" />
        <Toggle size="medium" />
        <Toggle size="large" />
